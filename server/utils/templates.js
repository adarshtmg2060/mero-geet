...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <h1 class="heading">
        Welcome to Mero Geet! We are thrilled to have you join our music
        community. 🎉
      </h1>
      <p class="paragraph">
        With Mero Geet, you can access millions of songs and podcasts, create your
...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <p class="paragraph">
        We're sorry to hear that you're having trouble accessing your Mero Geet
      ...
      <a class="link" href="http://localhost:5173/resetPassword/${resetToken}">Reset your password</a>
      <p class="paragraph">
